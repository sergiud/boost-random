 ...
 * generator.
 *
 * The implementation is based on "Panneton, F., L’Ecuyer, P., & Matsumoto, M.
...
BOOST_CONSTEXPR_OR_CONST uint_least32_t a1 = 0xda442d24U;
BOOST_CONSTEXPR_OR_CONST uint_least32_t a2 = 0xd3e43ffdU;
BOOST_CONSTEXPR_OR_CONST uint_least32_t a3 = 0x8bdcb91eU;
BOOST_CONSTEXPR_OR_CONST uint_least32_t a4 = 0x86a9d87eU;
BOOST_CONSTEXPR_OR_CONST uint_least32_t a5 = 0xa8c296d1U;
BOOST_CONSTEXPR_OR_CONST uint_least32_t a6 = 0x5d6b45ccU;
BOOST_CONSTEXPR_OR_CONST uint_least32_t a7 = 0xb729fcecU;
...
// Maximally equidistributed WELL versions using Harase's tempering method
// introduced in "Harase, S. (2009). Maximally equidistributed pseudorandom
// number generators via linear output transformations. Mathematics and
// Computers in Simulation, 79(5), 1512–1519.
// https://doi.org/10.1016/j.matcom.2008.06.006"
typedef mpl::apply1<detail::well800a_base,
    detail::harase_tempering<0x4880U> >::type maxeqdist_well800a;
typedef mpl::apply1<detail::well800b_base,
    detail::harase_tempering<0x17030806U> >::type maxeqdist_well800b;
// NOTE The paper mentions a 0x4118000 bit mask not 0x41180000 (note the
// additional trailing 0). However, the original implementation uses the latter.
typedef mpl::apply1<detail::well19937a_base,
